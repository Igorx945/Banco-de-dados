...
<head>
  ...
  <title>EMPRESTIMO LISTAGEM ATIVOS</title>
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css"> <link rel="stylesheet" href="listagensIndx.css">
    ...
    <div class="container">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
              <?php
              foreach(EmprestimoRepos::listAtivos() as $emprestimo){
              ?>
              <tr>
